...
d_header <- d_effort %>%
  select(StreamName, Date, 
         #Year, 
         #YearGroup, Season, 
         #Month, Month.no, Weeknum, j.date, Day, DayType, 
         Survey.Type, Surveyor, HeaderID) %>%
...
d_days %>% left_join(d_effort, by = "Date") #fields missing/NA for days without data collection

d_effort %>% left_join(d_days, by = "Date") #add days-fields to dates with data collection
```
