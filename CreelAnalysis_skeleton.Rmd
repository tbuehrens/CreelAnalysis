...
```{r standat_example}
standat <- list(
  #total number of days in the fishery we are estimating catch for
  #the span of interest, not the days for which data are available
  D = 1 + as.numeric(as.Date(analysis_args$date_end) - as.Date(analysis_args$date_start))
