...
params:
  ...
  water_body: "Skykomish River"
  date_start: "2021-05-29"   
  date_end: "2021-07-18"
  year_group: "2021-2022"
  sections: "lut_water_body_location_d13_skykomish_summer_chin.csv"
  species: "Chinook"
  fin_mark: "UM"
  fate: "Released"
  model_number: 4
...
lut <- map(
  list(
    river_loc = "input_files/river_locations_master.csv",
    creel_models = "input_files/lut_Creel_Models_2021-01-20.csv",
    sections = file.path("input_files", params$sections),
    census_expansion = "input_files/lut_Proportional_Expansions_for_Tie_In_Sections_Skykomish_Summer_Chin.csv"
  ),
  ~readr::read_csv(file.path(.x))
)

#5/21 update for dealing with newer multi-river file...
lut$river_loc <- filter(lut$river_loc, River == "Skykomish River")
...
only needed for Winter GF dev with prelim section LUT
