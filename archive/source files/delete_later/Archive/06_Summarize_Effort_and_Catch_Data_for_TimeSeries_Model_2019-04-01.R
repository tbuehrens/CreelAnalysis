...
standat<-list(
  ...
  IntViews=nrow(c_samp),              # total number of interviews
  gear_IntViews=c_samp$Gear,          # an indexing column with length equal to count of angler interviews with a 	1 or 2 depending on whether the interview was a boat or bank fisherman
  day_IntViews=c_samp$Day,            # an indexing column with length equal to count angler interviews with the day of the fishery listed starting at 1 and going to the last day n.
  section_IntViews = c_samp$Section.Num, #Section where angler was fishing (1 = Skagit, 2 = Sauk)
