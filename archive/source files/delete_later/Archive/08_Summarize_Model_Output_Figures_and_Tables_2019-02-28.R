...
#--------------------------------------------------------------------------------------------------------------------- - 
  ...
  #Export .csv of total catch and effort
    ...
    write.csv(catch.effort.totals, paste("Summary_Total_Catch_and_Effort", catch.group.of.interest, model.name, ".csv", sep="_"), row.names = T)
...
#--------------------------------------------------------------------------------------------------------------------- -   
  ...
  # write "Effort.summary" to a .csv file   
      write.csv(Effort.summary, paste("Summary_Effort (total hours per Period) by Section and Gear", catch.group.of.interest, model.name, ".csv", sep="_"), row.names = F)
...
if(model.number == 1){
  ...
  #=============================================================================================================== =
    ...
    # write "Catch.summary" to a .csv file   
       write.csv(Catch.summary, paste("Summary_Catch (total fish per Period) by Gear", catch.group.of.interest, model.name, ".csv", sep="_"), row.names = F)
  ...
  #=============================================================================================================== =  
    ...
    # write "CPUE.summary" to a .csv file   
       write.csv(CPUE.summary, paste("Summary_CPUE (fish per hr per Period) by Gear", catch.group.of.interest, model.name, ".csv", sep="_"), row.names = F)
  ...
  #=============================================================================================================== =
    ...
    # write "Catch.summary" to a .csv file   
       write.csv(Catch.summary, paste("Summary_Catch (total fish per Period) by Gear and Section", catch.group.of.interest, model.name, ".csv", sep="_"), row.names = F)
  ...
  #=============================================================================================================== =
    ...
    # write "CPUE.summary" to a .csv file   
       write.csv(CPUE.summary, paste("Summary_CPUE (fish per hr per Period) by Gear and Section", catch.group.of.interest, model.name, ".csv", sep="_"), row.names = F)   
}
...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    
  pdf(paste("Plots", catch.group.of.interest, model.name,".pdf", sep="_"), width=plot.width, height=plot.height)
  ...
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ~
      # set par arguments  
        par(mfcol=c(2,1), family='sans', xaxs="i", yaxs="i",cex.axis=1, cex=1, mgp=c(2,0.75, 0.5),mar=c(3,3,1,1), oma=c(4,3,1.5,1)) 
    
      #total seasonal catch    
        plot(density(apply(res$lambda_Ctot_S, c(1), sum)),col="blue",ylab="Total Catch (fish)", main="", bty="n")
        abline(v=mean(c(apply(res$lambda_Ctot_S, c(1), sum))),lwd=2, lty=2, col="red") #add abline for mean
        abline(v=median(c(apply(res$lambda_Ctot_S, c(1), sum))),lwd=2, lty=2,  col="blue") #add abline for median
        ...
        legend("topright", c("mean", "median", "95%CI"), lty=2, col=c("red", "blue", "black"), bty="n", lwd=2)
      
      #total seasonal effort  
        plot(density(res$E_sum),col="blue",ylab="Total Effort (hrs)", main="", bty="n")
        abline(v=mean(res$E_sum),lwd=2, lty=2, col="red") #add abline for mean
        abline(v=quantile(res$E_sum, 0.5),lwd=2, lty=2,  col="blue") #add abline for median
  ...
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ~
      ...
      # set par arguments    
          par(mfcol=c(length(unique(Effort.summary$Section)),1), family='sans', xaxs="i", yaxs="i",cex.axis=1, cex=1, mgp=c(2,0.75, 0.5),mar=c(2,2,1,1), oma=c(3,3,1.5,1)) 
...
if(model.number == 1){
      ...
      #=============================================================================================================== =
          # windows(height=11, width=8.5)
          par(mfcol=c(length(unique(Catch.summary$Gear)),1), family='sans', xaxs="i", yaxs="i",cex.axis=1, cex=1, mgp=c(2,0.75, 0.5),mar=c(2,2,1,1), oma=c(3,3,1.5,1)) 
    ...
    #=============================================================================================================== =
      #windows(height=11, width=8.5)
          ...
          par(mfcol=c(length(unique(Catch.summary$Section)),1), family='sans', xaxs="i", yaxs="i",cex.axis=1, cex=1, mgp=c(2,0.75, 0.5),mar=c(2,2,1,1), oma=c(3,3,1.5,1)) 
...
if(model.number == 1){
      ...
      #=============================================================================================================== =
          # windows(height=11, width=8.5)
          par(mfcol=c(length(unique(CPUE.summary$Gear)),1), family='sans', xaxs="i", yaxs="i",cex.axis=1, cex=1, mgp=c(2,0.75, 0.5),mar=c(2,2,1,1), oma=c(3,3,1.5,1)) 
    ...
    #=============================================================================================================== =
      #windows(height=11, width=8.5)
          ...
          par(mfcol=c(length(unique(CPUE.summary$Section)),1), family='sans', xaxs="i", yaxs="i",cex.axis=1, cex=1, mgp=c(2,0.75, 0.5),mar=c(2,2,1,1), oma=c(3,3,1.5,1)) 
  ...
  #       
  #     # set par arguments    
  #         par(mfcol=c(length(unique(prop.E.summary$Section)),1), family='sans', xaxs="i", yaxs="i",cex.axis=1, cex=1, mgp=c(2,0.75, 0.5),mar=c(2,2,1,1), oma=c(3,3,1.5,1)) 
  #     
