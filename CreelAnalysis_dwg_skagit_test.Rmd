...
params:
  ...
  sections: "lut_water_body_location_d14_skagit_spring_Chinook_upper.csv"
  species: "Chinook"
  fin_mark: "UM"
  fate: "Released"
...
lut <- map(
  list(
    ...
    census_expansion = "input_files/lut_Proportional_Expansions_for_Tie_In_Sections_Skagit_Spring_Chinook_Upper.csv"
...
d_days <- rows_upsert(d_days,
    bind_rows(
      tibble(section = "1", closure_begin = "2021-05-31", closure_end = "2021-05-31") # salmon opens on 9/1 for sections 3,4
