...
Combines the angler fields with the catch fields (from the subset of interviews in which catches were reported and recorded).

```{r stan_data_prelim_interview}
stan_data_prelim$interview <- creel$interview |> 
