...
n_iter <- 100 # DA uses 200 for quick see if it breaks fit; TB and DA suggest that 1,000 should be sufficient, maybe more for final end of season estimate 
n_warmup <- n_iter/2
