...
#======================================================
effort_file_name <-   "03_Effort_dat - 2021_Skykomish_creel thru July 3.csv"
interview_file_name <-"03_Interview-dat_2021_Skykomish_creel thru July 3.csv"
...
#======================================================  
  catch.group.of.interest<-c("CH_H_K") 
...
# Assign a "Model_Run" number (if model_source == run_new, results will be saved to a new sub-folder; if model_source == load_saved, previous model results will be loaded)
  Model_Run<-"July3_mod1" #Enter numeric number (NOTE: be careful not to over-write previous models runs by entering a number that's already been used)
...
#convergence diagnostics
  ...
  if(launch_diagnostics=="Yes"){launch_shinystan(res_Stan)} 
