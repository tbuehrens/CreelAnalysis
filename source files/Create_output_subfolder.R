...
# waterbody group  
  filepath_waterbody<-paste(wd_outputs, StreamName.of.Interest, sep="/")
  ifelse(!dir.exists(filepath_waterbody), {dir.create(filepath_waterbody); "Waterbody group sub-folder created"},"Waterbody group sub-folder exists already")

# catch group  
  filepath_catchgroup<-paste(filepath_waterbody, catch.group.of.interest, sep="/")
