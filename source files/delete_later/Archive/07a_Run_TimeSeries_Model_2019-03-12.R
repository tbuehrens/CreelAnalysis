...
if(model.source== "saved"){
  ...
  #Extract posterior draws 
    ...
    # Add priors to "standat"
      ...
      standat$prior_sigma_E_H<-prior_sigma_E_H     
      standat$prior_B1<-prior_B1                 
      standat$prior_r_C<-prior_r_C   #standat$prior_phi_NB_C<-prior_phi_NB_C  
      standat$prior_eps_C_0<-prior_eps_C_0         
      standat$prior_eps_E_0<-prior_eps_E_0        
      standat$prior_b<-prior_b                    
      standat$prior_mu_C_mu_mu<-prior_mu_C_mu_mu   
      standat$prior_mu_C_mu_sd<-prior_mu_C_mu_sd   
      standat$prior_mu_E_mu_mu<-prior_mu_E_mu_mu   
      standat$prior_mu_E_mu_sd<-prior_mu_E_mu_sd   
