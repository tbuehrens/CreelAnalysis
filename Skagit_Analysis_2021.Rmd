...
#======================================================
effort_file_name <-   "Effort_dat_2021_steelhead_03302021.csv"
interview_file_name <-"Interview_dat_2021_steelhead_cleaned_03302021.csv"
...
# First, denote the total number of dates when the fishery was closed (the closure can be for the entire fishery -- all sections -- or a portion of the fishery)
  ...
  total.closed.dates<-24 # Total number of dates that at least one section of the river was closed 
